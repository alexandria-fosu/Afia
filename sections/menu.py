   ...
   with ui.column().classes("justify-center flex flex-col w-full h-full gap-12 p-8 items-center z-10"):
        ...
        with ui.element("div").classes("w-full items-center relative h-full overflow-hidden rounded-2xl shadow-lg grid grid-cols-3 gap-hiddden"):
            with ui.column().classes('relative'):
                ui.image("assets/images/noodles-4851996_1280.jpg").classes("w-[500px] h-auto rounded-lg shadow-xl object-cover transition-transform duration-300 hover:scale-110")
            ...
            with ui.column().classes("relative"):
                ui.image("assets/images/pudding-702960_1280.jpg").classes("w-[500px] h-full rounded-lg shadow-xl object-cover transition-transform duration-300 hover:scale-110")
            ...
            with ui.column().classes("relative"):    
                ui.image("assets/images/salad-3477928_1280.jpg").classes("w-[550px] h-auto rounded-lg shadow-xl object-cover transition-transform duration-300 hover:scale-110")
                ui.label("Starter").classes("absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 items-center text-bold text-2xl") \
                .classes("bg-white text-black px-6 py-2 rounded-full font-bold cursor-pointer w-[130px] h-[50px]") 
            with ui.column().classes("relative"):    
                ui.image("assets/images/grilling-2415223_1280.jpg").classes("w-[500px] h-auto rounded-lg shadow-xl object-cover transition-transform duration-300 hover:scale-110")
                ui.label("Grills").classes("absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 items-center text-bold text-2xl") \
                .classes("bg-white text-black px-6 py-2 rounded-full font-bold cursor-pointer w-[130px] h-[50px]")
            with ui.column().classes("relative"):
                ui.image("assets/images/burger-7175344_1280.jpg").classes("w-[500px] h-auto rounded-lg shadow-xl object-cover transition-transform duration-300 hover:scale-110")
                ui.label("Burgers").classes("absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 items-center text-bold text-2xl") \
                .classes("bg-white text-black px-6 py-2 rounded-full font-bold cursor-pointer w-[130px] h-[50px]")
            with ui.column().classes("relative"):
                ui.image("assets/images/drink-4389934_1920.jpg").classes("w-[500px] h-auto rounded-lg shadow-xl object-cover transition-transform duration-300 hover:scale-110")
